...
`string_functions.c`, `nstrings.c`, `hash_djb2.c`, `randomm.c`, `file_io.c` (read/write data/time), `fdfn.c` (file/dir helpers), `dirlist.c`, `errors.c` (error reporting) — generic helpers used throughout both binaries.
