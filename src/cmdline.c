...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->start_help = gengetopt_args_info_help[2] ;
  ...
  args_info->once_help = gengetopt_args_info_help[6] ;
  args_info->config_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->once_given)
    write_into_file(outfile, "once", 0, 0 );
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "restart") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->restart_given),
                &(local_args_info.restart_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "restart", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "once") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->once_given),
                &(local_args_info.once_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "once", '-',
                additional_error))
              goto failure;
